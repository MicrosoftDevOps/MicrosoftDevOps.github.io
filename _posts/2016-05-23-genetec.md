...
During our Hackfest, we worked mainly on the back end of Stratocast.
...
* Cloud Services with 5 worker role
* Azure Queue
* Azure SQL databases
* Storage accounts
...
We focused our technical efforts mainly on the backend solution, which is using a Cloud Services architecture on Microsoft Azure.
