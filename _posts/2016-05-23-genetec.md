...
Even if it’s complicated to change everything about the process in a team in 1 week, the most important lesson that Genetec realized during this exercise is the communication. 
Take the time to organize some events like we did, during this Hackfest, to answer questions together and realized about:

* How I can improve the lead time;
* Can I automatize this task that I’m doing manually every day;
* Can I improve the quality of our code by adding tests;
* How can I add feedbacks earlier inside my code;
* …

This kind of event/exercise is all the principle of the [Kaizen movement: the “Continuous Improvement”](https://en.wikipedia.org/wiki/Kaizen)
Take the time to talk each other’s on how we can add value to our customers together by eliminating our waste: Developers, Ops, Tests, PO, Manager and also CEO / CTO ...
