...
Genetec was present at our Microsoft DevOps Hackathon training event in Montreal in March 2016; during this two-day event, we introduced them to some DevOps concepts and showed them how to embrace a DevOps mindset.

*Figure 1: Value Stream Map of Genetec application*

![Figure 1: Value Stream Map of Genetec application](/images/genetec1.jpg)

Three months later, we teamed up with Genetec for a Hackfest (see Figure 1) with a goal of improving and implementing some DevOps practices in their current production environment.
...
**Questions for authors: Is it 4 to 5? (rather than four/fifths.) Should it be "worker roles"? Is "storages" supposed to be plural, or should it be "storage accounts"? **
